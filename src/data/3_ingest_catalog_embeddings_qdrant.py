...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Embed and ingest sensor_catalog.jsonl into Qdrant.")
    ...
    # Job
    p.add_argument("--catalog-path", type=Path, default=Path("data/sensor_catalog.jsonl"))
    p.add_argument("--collection", type=str, default="catalog_embeddings")
